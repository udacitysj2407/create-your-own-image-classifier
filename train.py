...
parser.add_argument('--epoch_num', dest = "epoch_num", action = "store", type = int, default = 5, help = "epoch value")
...
parser.add_argument('--fc2', type = int, dest = "fc2", action = "store", default = 1024, help = "state the units for fc2")
